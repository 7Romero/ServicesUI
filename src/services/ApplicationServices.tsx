...
const ApplicationServices = {
    ...
    UpdateApplication: async (id: string, application: ApplicationDto) => {
        const responseFormat: ResponseDto = {
            Status: false,
            Variant: "default",
            Message: "",
        ...
        await api.application.UpdateApplication(id, application)
            .then(function (response) {
                responseFormat.Status = true;
                responseFormat.Data = response.data;
            })
    ...
    GetApplicationsForOrder: async (orderId: string) => {
        const responseFormat: ResponseDto = {
            Status: false,
            Variant: "default",
            Message: "",
        ...
        await api.application.GetApplicationsForOrder(orderId)
            .then(function (response) {
                responseFormat.Status = true;
                responseFormat.Data = response.data;
            })
